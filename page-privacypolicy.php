	...
	<div class=" section section__col">
		<div class="section__side">
			<ul id="sidemenu">
				...
				<li><a data-slug="procedure" href="<?php echo home_url('/privacypolicy/#opposition-forces'); ?>">反社会的勢力へ<br class="sp-only">の対応</a></li>
			</ul>
		</div>
		<div class="section__main wrapper-136">
				...
				<div class="txt mt32">
					...
					<p class="text-flex mt8--sp12">
						...
						<span>住所 ： 〒529-1302滋賀県愛知郡愛荘町川原771-1<br>
							電話 ： <a href="tel:0749428400">0749-42-8400</a><br>
			...
			<section class="component-box-item opposition-forces" id="opposition-forces">
				<h2 class="ttl-01">反社会的勢力への対応</h2>
				<div class="txt mt32--sp24">
					<p>近江印刷株式会社は、市民社会の秩序や安全に脅威を与える反社会的勢力に対する基本方針を以下のとおり定め、反社会的勢力を排除することを宣言します。</p>
					<ol class="privacy__list mt32">
					<li class="privacy__condition">
						<span>1.&nbsp;</span>暴力団・暴力団構成員・暴力団準構成員・暴力団関係企業・総会屋・社会運動標ぼうゴロ・特殊知能暴力集団等、反社会的勢力と一切の関係を遮断します。
					</li>
					<li class="privacy__condition">
						<span>2.&nbsp;</span>反社会的勢力による不当要求に対しては、従業員の安全確保に配慮し、民事・刑事の両面から法的対抗措置を講じる等、断固たる態度で対応します。
					</li>
					<li class="privacy__condition">
						<span>3.&nbsp;</span>相手方が反社会的勢力であると判明した場合や、反社会的勢力であるとの疑いが生じた時点で一切の契約を解消します。
					</li>
					<li class="privacy__condition">
						<span>4.&nbsp;</span>反社会的勢力による被害を防止するために、反社会的勢力との雇用契約その他、一切の労働契約を締結しません。
					</li>
					<li class="privacy__condition">
						<span>5.&nbsp;</span>反社会的勢力による不当要求がいかなる場合であっても、事実を隠蔽するための裏取引等を一切行いません。また、反社会的勢力への資金提供をせず、いかなる便宜供与も受けません。
					</li>
					<li class="privacy__condition">
						<span>6.&nbsp;</span>反社会的勢力による被害を防止するため、警察・暴力追放運動推進センター・弁護士などの外部専門機関と緊密な連携関係を構築します。
					</li>
				</ol>
				</div>
			</section>
