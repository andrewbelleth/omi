...
<div class="page__head-inner pallax-fixed">
...
<div class="page-wrapper">
    <div class="pallax-bg pallax-fixed">
        <picture>
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/recruit/recruit-mv.webp" media="(min-width: 768px)">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/recruit/sp-recruit-mv.webp" loading="eager" decoding="async" alt="近江印刷リクルートページのメインビジュアル" width="1439" height="640" />
        </picture>
    </div><!-- / -->
        <section class="recruit pt160--sp96 pallax-fixed">
